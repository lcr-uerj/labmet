  ...
  <div>
    <div class="fundo">
      <div class="flex-wrap flex justify-center container items-center mt-32 mx-auto">
        <h2 class="size-banner">Quem somos <br>e Equipe</h2>
      </div>
    </div>
      <!-- component -->
      <!-- MDI Icons -->
      ...
      <!-- Page Container -->
      <div class="flex items-center justify-center min-h-screen py-14 bg-gray-500">
